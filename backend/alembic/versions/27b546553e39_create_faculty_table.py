...
Revision ID: 27b546553e39
Revises: 84083e6171fa
Create Date: 2026-08-25 12:47:30.285652
...
revision: str = '27b546553e39'
down_revision: Union[str, Sequence[str], None] = '84083e6171fa'
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_faculty_employee_code'), 'faculty', ['employee_code'], unique=True)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_faculty_employee_code'), table_name='faculty')
